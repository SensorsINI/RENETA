...
#     --model_pretrain 'cla-rnn' --rnn_type 'LSTM' --rnn_size 128 \
...
#     --model_pretrain 'cla-rnn' --model_retrain 'cla-rnn' --rnn_type 'LSTM' --rnn_size 128 \
#     --eval_val 1 --eval_test 1 --lr_schedule 1 \
#     --write_log 1 --save_best_model 0 \
...
# python main.py --dataset gscdv2 --feat_folder '5' \
#     --il_load_pretrain 1 \
#     --step retrain --epochs_retrain 10 --batch_size 1 --lr 3e-5 \
#     --model_pretrain 'cla-rnn' --model_retrain 'cla-rnn' --rnn_type 'LSTM' --rnn_size 128 \
#     --eval_val 1 --eval_test 1 --lr_schedule 1 \
#     --write_log 1 --save_best_model 0 \
#     --il_mode 1 --num_learned_classes 20 --num_new_classes 3 --num_exemplars 2000
...
# python main.py --dataset gscdv2 --feat_folder '5' \
#     --step pretrain --epochs_pretrain 1 --batch_size 32 \
#     --model_pretrain 'cla-rnn' --rnn_type 'LSTM' --rnn_size 128 \
#     --eval_val 1 --eval_test 1 --lr_schedule 1 \
...
#     --model_pretrain 'cla-rnn' --model_retrain 'cla-rnn' --rnn_type 'LSTM' --rnn_size 128 \
#     --eval_val 1 --eval_test 1 --lr_schedule 1 \
#     --write_log 0 --save_best_model 0 --il_save_model 1 \
#     --il_mode 1 --num_learned_classes 23 --num_new_classes 3 --num_exemplars 2000
